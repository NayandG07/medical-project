...
-- Version: 008
-- Date: 2026-02-07
-- Description: Creates all tables required for the Interactive Learning Assistant (Teach-Back Mode) feature
...
-- Create indexes for teach_back_sessions
...
DROP TRIGGER IF EXISTS update_teach_back_sessions_updated_at ON teach_back_sessions;
